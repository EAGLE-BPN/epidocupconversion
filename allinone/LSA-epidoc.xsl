...
<!--    breaks up sections and call templates to normalize ()[] and to convert in epidoc -->
    ...
    <xsl:include href="https://raw.github.com/PietroLiuzzo/epidocupconversion/master/allinone/bracketsLSA.xsl"/>


<!--  Takes all brackets sets and other diacritic and substitutes them with markup  -->
<xsl:include href="https://raw.github.com/PietroLiuzzo/epidocupconversion/master/allinone/upconversionLSA.xsl"/>    
